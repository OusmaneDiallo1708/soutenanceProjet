...
//       showNotification("error", "Veuillez choisir un nom de catégorie.");
//       setIsSubmitting(false);
//       return;
//     }
//     if (!formData.categorieDescription) {
//       showNotification("error", "Veuillez choisir une description de catégorie.");
//       setIsSubmitting(false);
//       return;
//     }
...
//         });
//       } else {
//         showNotification("error", result.message || "Erreur lors de l'ajout du produit.");
//       }
//     } catch (error) {
//       console.error(error);
//       showNotification("error", "Problème de connexion au serveur.");
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
...
//   // 🔹 Remplissage automatique de la description
...
//       ...prev,
//       categorieId,
//       categorieDescription: categorie ? categorie.description : "",
//     }));
//   };
...
//               name="categorieId"
//               value={formData.categorieId}
//               onChange={handleCategorieChange} // <-- Remplissage automatique
//               className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm"
//               required
//             >
//               <option value="">-- Choisir une catégorie --</option>
...
//               value={formData.categorieDescription}
//               readOnly
//               className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 shadow-sm bg-gray-50"
//               placeholder="La description se remplira automatiquement"
//             />
//           </div>
//         </div>
...
//   // 🔹 Remplir la description automatiquement
//   const handleCategorieChange = (e) => {
//     const categorieId = e.target.value;
//     const categorie = categories.find((cat) => cat._id === categorieId);
...
//     if (!formData.categorieId) {
//       showNotification("error", "Veuillez choisir une catégorie.");
//       setIsSubmitting(false);
//       return;
//     }
...
//         "http://localhost:4999/api/allroute/addProduit",
//         formData,
//         {
//           withCredentials: true, // 🔑 envoie le cookie JWT au backend
...
//         className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-8 rounded-2xl shadow-md border border-gray-100"
//       >
...
//               value={formData.categorieDescription}
//               readOnly
//               className="w-full p-3 border border-gray-300 rounded-xl bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm"
//             />
//           </div>
//         </div>
...
//           <label className="block text-sm font-medium text-gray-700 mb-2 ml-1">Image du produit</label>
//           <div className="flex items-center justify-center w-full">
//             <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-blue-300 rounded-2xl cursor-pointer bg-blue-50 hover:bg-blue-100">
//               <div className="flex flex-col items-center justify-center pt-5 pb-6">
//                 <svg
...
const AddProductForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const fields = [
        'categorieId', 'categorieDescription', 'quantite', 
        'prixAchat', 'prixVente', 'stock_min', 
        'date_ajout', 'date_expiration', 'alert_stock'
      ];
      ...
      if (response.status === 201) {
        ...
        showNotification("error", response.data.message || "Erreur lors de l'ajout du produit.");
      }
    } catch (error) {
